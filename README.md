...
```
cd existing_repo
git remote add origin https://gitlab.upt.ro/cristian.faur/os_project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.upt.ro/cristian.faur/os_project/-/settings/integrations)
